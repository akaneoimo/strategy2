...
from News_Demo.core.config import Config
from News_Demo.core.dataset import Dataset
from News_Demo.core.embedding import Embedding
from News_Demo.core.factory import Factory
from News_Demo.core.logger import Logger
from News_Demo.core.metric import Metric
from News_Demo.core.model import Model
...
def train(config_filename):
    ...
    word_vector_file = config.word_vector_file
